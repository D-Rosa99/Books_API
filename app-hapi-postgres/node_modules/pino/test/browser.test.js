...
test('opts.browser.asObject logs pino-like object to console', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.write func string joining when asObject is true', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.write func string object joining when asObject is true', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.write obj writes to methods corresponding to level', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.asObject/write supports child loggers', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.asObject/write supports child child loggers', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.asObject/write supports child child child loggers', ({
  end,
  ok,
  is,
}) => {
...
test('opts.browser.asObject defensively mitigates naughty numbers', ({
  end,
  pass,
}) => {
  const instance = pino({
