...
test('throws if transmit object does not have send function', ({
  end,
  throws,
}) => {
  throws(() => {
...
test('passes send function child bindings via logEvent object', ({
  end,
  same,
  is,
}) => {
...
test('passes send function level:{label, value} via logEvent object', ({
  end,
  is,
}) => {
  const logger = pino({
...
test('transmit.level is effective even if lower than logger level', ({
  end,
  is,
}) => {
  var c = 0;
...
test('applies all serializers to messages and bindings (serialize:true)', ({
  end,
  same,
  is,
}) => {
...
test('extracts correct bindings and raw messages over multiple transmits', ({
  end,
  same,
  is,
}) => {
