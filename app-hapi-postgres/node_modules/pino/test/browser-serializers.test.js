...
test('without the serialize option, serializers do not override values', ({
  end,
  is,
}) => {
  const parent = pino({
...
test('children serializers get called when inherited from parent', ({
  end,
  is,
}) => {
  const parent = pino({
...
test('non overriden serializers are available in the children', ({
  end,
  is,
}) => {
  const pSerializers = {
