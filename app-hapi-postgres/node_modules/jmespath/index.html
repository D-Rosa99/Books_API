    ...
    <div class="container-fluid">
      <div class="hero-unit">
        ...
        <div id="info">
          <p>
            Author:
            <a href="http://ashphy.com/">Kazuki Hamasaki</a> [ashphy@ashphy.com]
          </p>
          <p>
            This evaluator uses
            <a href="http://goessner.net/articles/JsonPath/"
              >JSONPath - XPath for JSON</a
            >
          </p>
        </div>
      </div>
        ...
        <div class="span6">
          ...
          <form>
            ...
            <input
              ...
              value="$.phoneNumbers[:1].type"
            />
            <span class="help-block"
              >Example '$.phoneNumbers[*].type' See also
              <a href="http://goessner.net/articles/JsonPath/index.html#e2"
                >JSONPath expressions</a
              ></span
            >
            <label>JSON</label>
