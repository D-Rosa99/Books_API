...
const joycon = new JoyCon({
  parseJSON,
  files: ['pino-pretty.config.js', '.pino-prettyrc', '.pino-prettyrc.json'],
...
args
  ...
  .option(
    ['l', 'levelFirst'],
    'Display the log level as the first output field'
  )
  .option(
    ['k', 'errorLikeObjectKeys'],
    'Define which keys contain error objects (`-k err,error`)',
    'err,error'
  )
  .option(
    ['m', 'messageKey'],
  ...
  .option(
    'levelKey',
    'Detect the log level under the specified key',
    CONSTANTS.LEVEL_KEY
  )
  ...
  .option(
    'config',
    'specify a path to a json file containing the pino-pretty options'
  );
...
args
  ...
  .example(
    ...
    "To highlight a string at a key other than 'msg', use"
  )
  .example(
    'cat log | pino-pretty --levelKey fooLevel',
    "To detect the log level at a key other than 'level', use"
  )
  .example(
    'cat log | pino-pretty -a fooTimestamp',
    "To display timestamp from a key other than 'time', use"
  )
  .example(
  ...
  .example(
    'cat log | pino-pretty -s "msg == \'hello world\'"',
