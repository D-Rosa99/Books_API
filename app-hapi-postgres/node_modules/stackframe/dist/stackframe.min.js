!(function (t, e) {
  ...
  for (var u = 0; u < r.length; u++)
    (s.prototype['get' + t(r[u])] = e(r[u])),
      (s.prototype['set' + t(r[u])] = (function (t) {
        return function (e) {
          this[t] = Boolean(e);
        };
      })(r[u]));
  for (var a = 0; a < n.length; a++)
    (s.prototype['get' + t(n[a])] = e(n[a])),
      (s.prototype['set' + t(n[a])] = (function (t) {
        return function (e) {
  ...
  for (var f = 0; f < i.length; f++)
    (s.prototype['get' + t(i[f])] = e(i[f])),
      (s.prototype['set' + t(i[f])] = (function (t) {
        return function (e) {
          this[t] = String(e);
        };
      })(i[f]));
