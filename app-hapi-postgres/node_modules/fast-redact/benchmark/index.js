...
const redactWildNoSerialize = fastRedact({
  paths: ['a.b.*'],
  serialize: false,
});
const redactIntermediateWildNoSerialize = fastRedact({
  paths: ['a.*.c'],
  serialize: false,
});
...
const redactIntermediateWildMatchWildOutcome = fastRedact({
  paths: ['a.*.c', 'a.*.b', 'a.*.a'],
});
const redactStaticMatchWildOutcome = fastRedact({
  paths: ['a.b.c', 'a.d.a', 'a.d.b', 'a.d.c'],
});
const noirCensorFunction = require('pino-noir')(['a.b.*'], (v) => v + '.');
const redactCensorFunction = fastRedact({
  paths: ['a.b.*'],
  censor: (v) => v + '.',
  serialize: false,
});
