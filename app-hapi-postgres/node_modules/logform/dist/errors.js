...
module.exports = format(function (einfo, _ref) {
  ...
  if (einfo instanceof Error) {
    ...
    var info = Object.assign(
      ...
      _defineProperty(_Object$assign, LEVEL, einfo[LEVEL] || einfo.level),
      _defineProperty(_Object$assign, 'message', einfo.message),
      _defineProperty(_Object$assign, MESSAGE, einfo[MESSAGE] || einfo.message),
      _Object$assign)
    );
